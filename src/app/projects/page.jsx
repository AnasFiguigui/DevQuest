...
export const metadata = {
  title: 'Projets',
  description: 'Mises en pratique et explorations techniques',
}
      ...
      >
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            ...
            <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-yellow-400 dark:text-zinc-200">
