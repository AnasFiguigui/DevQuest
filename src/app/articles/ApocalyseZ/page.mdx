...
import video1 from '@/images/photos/video-1.gif';
import video2 from '@/images/photos/video-2.gif';
import video3 from '@/images/photos/video-3.gif';
...
<Image src={video1} alt="Capture d'écran du gameplay de Apocalypse Z" />
...
```
<Image src={video2} alt="Capture d'écran du gameplay de Apocalypse Z" />
### 3. **IA Ennemi**
...
```
<Image src={image5} alt="Capture d'écran du gameplay de Apocalypse Z" />
### 4. **Système de Mort**
