    ...
    <tr>
      <td style="padding: 40px 20px;">
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
          ...
          <!-- Header -->
          <tr>
            <td style="background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); padding: 32px 40px; text-align: center;">
          ...
          <tr>
            <td style="padding: 40px;">
                    ...
                    <table role="presentation" style="width: 100%;">
                      <tr>
                        <td style="width: 48px; vertical-align: top;">
                          <div style="width: 48px; height: 48px; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
              ...
              <div style="margin-bottom: 32px;">
                ...
                <div style="background-color: #fafafa; border-left: 4px solid #14b8a6; padding: 20px; border-radius: 0 8px 8px 0;">
              ...
              <table role="presentation" style="width: 100%;">
                <tr>
                  <td style="text-align: center;">
                    <a href="mailto:${email}?subject=Re: Your message on DevQuest" style="display: inline-block; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 14px; font-weight: 600; letter-spacing: 0.3px;">
                ...
                <tr>
                  <td style="text-align: center;">
                    <p style="margin: 0; font-size: 13px; color: #a1a1aa;">
                      Sent from <a href="https://anasfiguigui.xyz" style="color: #14b8a6; text-decoration: none; font-weight: 500;">DevQuest</a> contact form
                    </p>
