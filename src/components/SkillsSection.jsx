...
const defaultSkillsData = [
  {
    ...
    skills: [
      ...
      { name: 'HTML', icon: '/images/technologies/html.svg' },
      { name: 'CSS', icon: '/images/technologies/css.svg' },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Spring', icon: '/images/technologies/spring.svg' },
      { name: 'Laravel', icon: '/images/technologies/laravel.svg' },
      { name: 'Symfony', icon: '/images/technologies/symfony.svg' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Notion', icon: '/images/technologies/notion.svg' },
      { name: 'Obsidian', icon: '/images/technologies/obsidian.svg' },
      { name: 'WordPress', icon: '/images/technologies/wordpress.svg' },
      { name: 'Excel', icon: '/images/technologies/excel.svg' },
      { name: 'Namecheap', icon: '/images/technologies/namecheap.svg' },
